  ...
  >
    ...
    >
      ...
      <div class="relative max-h-[195px]">
        ...
        <span
          class="absolute top-[85%] left-1/2 -translate-x-1/2 -translate-y-[85%] rounded-full bg-success-50 px-3 py-1 text-xs font-medium text-success-600 dark:bg-success-500/15 dark:text-success-500"
          >+10%</span
        >
      </div>
      <p
