        ...
        <div>
          ...
          <div class="grid grid-cols-1 gap-4 lg:grid-cols-2 lg:gap-7 2xl:gap-x-32">
            ...
            <div>
              ...
              <p class="text-sm font-medium text-gray-800 dark:text-white/90">Gamal</p>
            </div>
            ...
            <div>
              ...
              <p class="text-sm font-medium text-gray-800 dark:text-white/90">+0234567890</p>
            </div>
      ...
      <template #body>
        ...
        >
          ...
          <div class="px-2 pr-14">
            ...
            <p class="text-sm text-gray-500 dark:text-gray-400 lg:mb-7">
